...
import argparse
import numpy as np
from modules.tokenizers import Tokenizer, MedicalReportTokenizer, ModernTokenizer
...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='/mnt/e/challenge/reg/HistGen/dataset/DINOv2_Features/', help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='/mnt/e/challenge/reg/HistGen/dataset/annotation712_update.json', help='the path to the directory containing the data.')
    # Add this for vocabulary path
    parser.add_argument('--vocab_path', type=str, default=None,
                        help='Path to the pre-computed vocabulary file (e.g., vocab.json). If provided, vocab construction from ann_path is skipped.')
...
def main():
    ...
    #     print(f"Saving newly built vocabulary to {args.vocab_path}")
    #     tokenizer.save_vocabulary(args.vocab_path)
